...
class TrainFilteredAe:
    ...
    def execute(self):
        ...
        compressed_data = self.autoencoder.encode(X).cpu().detach().numpy()

        # Custer with dbscan
        print("Clustering with DBSCAN...")
        clustering = hdbscan.HDBSCAN().fit(compressed_data)
        compressed_labels = clustering.labels_

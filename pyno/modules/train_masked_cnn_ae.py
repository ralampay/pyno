...
class TrainMaskedCnnAe:
    def __init__(self, params=None):
        ...
        self.masked_img_dir     = params.get('masked_img_dir')
    ...
    def execute(self):
        ...
        """
        Load masked images with proper dimensions as input data
        """
        y = load_image_tensors(self.masked_img_dir, self.img_width, self.img_height)
        y = y.to(self.device)
